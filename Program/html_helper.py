        ...
        for i in results:
            ...
            for j in res:
                ...
                if(item['label'] == 'positive'):
                    left += '<li title="'+self.weekDates[i]+'">' + item['tweet'] \
                    + '<form><input type="radio" name="'+item['tweet']+'" value = "positive" checked> Positive'\
                    +'<input type="radio" name="'+item['tweet']+'" value = "neutral"> Neutral'\
                    +'<input type="radio" name="'+item['tweet']+'" value = "negative" > Negative'\
                    +'</form></li>'
                elif(item['label'] == 'neutral'):
                    middle+= '<li title="'+self.weekDates[i]+'">' + item['tweet'] \
                    + '<form><input type="radio" name="'+item['tweet']+'" value = "positive" > Positive'\
                    +'<input type="radio" name="'+item['tweet']+'" value = "neutral" checked> Neutral'\
                    +'<input type="radio" name="'+item['tweet']+'" value = "negative" > Negative'\
                    +'</form></li>'
                elif(item['label'] == 'negative'):
                    right += '<li title="'+self.weekDates[i]+'">' + item['tweet'] \
                    + '<form><input type="radio" name="'+item['tweet']+'" value = "positive"> Positive'\
                    +'<input type="radio" name="'+item['tweet']+'" value = "neutral"> Neutral'\
                    +'<input type="radio" name="'+item['tweet']+'" value = "negative" checked> Negative'\
                    +'</form></li>'
            #end innerloop
        #end outerloop
        left += '</ul><input type="submit"></div>'
        right += '</ul><input type="submit"></div>'
        middle += '</ul><input type="submit"></div>'
